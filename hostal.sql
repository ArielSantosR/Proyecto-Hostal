...
FOR EACH ROW
 WHEN (new.ID_PRODUCTO IS NULL or new.ID_PRODUCTO = 0) 
BEGIN
...
CREATE OR REPLACE FUNCTION FN_PRODUCTO (P_ID_PROVEEDOR IN PROVEEDOR.RUT_PROVEEDOR%TYPE,
...
SELECT CONCAT(CONCAT(SUBSTR(P_ID_PROVEEDOR, 1, 3),
