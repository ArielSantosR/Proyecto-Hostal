...
CREATE OR REPLACE TRIGGER TGR_FECHA_PRODUCTO
BEFORE INSERT ON PRODUCTO
FOR EACH ROW
 WHEN (TO_CHAR(TO_DATE(NEW.FECHA_VENCIMIENTO_PRODUCTO), 'DD/MM/YYYY') = TO_CHAR(TO_DATE('01/01/2000'), 'DD/MM/YYYY'))
...
BEGIN
  ...
  V_ID_PRODUCTO:= FN_PRODUCTO(:NEW.RUT_PROVEEDOR,  :NEW.ID_FAMILIA, V_FECHA, V_SECUENCIA);
