...
--Agregar Columnas a PEdido

ALTER TABLE PEDIDO
ADD ESTADO_DESPACHO VARCHAR2(25) NOT NULL;
...
ALTER TABLE HABITACION 
ADD CONSTRAINT FK_HABITACION_CATEGORIA_HAB FOREIGN KEY (ID_CATEGORIA_HABITACION) REFERENCES CATEGORIA_HABITACION(ID_CATEGORIA_HABITACION);
