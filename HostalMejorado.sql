...
ID_PENSION NUMBER(5),
NOMBRE_PENSION VARCHAR2(35) NOT NULL,
...
NUMERO_RECEPCION NUMBER(5) NOT NULL,
...
CANTIDAD NUMBER(10) NOT NULL,
NUMERO_PEDIDO NUMBER(5) NOT NULL,
ID_PRODUCTO NUMBER(19) NOT NULL,
...
BEGIN
    ...
    IF :NEW.ESTADO_ORDEN != 'Pendiente' THEN
      ...
      IF :NEW.ESTADO_ORDEN = 'Aceptado' THEN
        FOR I IN CUR_USUARIO LOOP
          INSERT INTO NOTIFICACION(ID_NOTIFICACION, MENSAJE, ID_USUARIO, ESTADO_NOTIFICACION, URL, NUMERO_ORDEN)
          VALUES(SEQ_NOTIFICACION.NEXTVAL, 'La Reserva ' || :new.NUMERO_ORDEN || ' ha sido aceptada, debe asignar la habitación', I.ID_USUARIO, 'Habilitado', '../Empleado/WebAsignarHabitacion.aspx', :NEW.NUMERO_ORDEN);
        END LOOP;
      END IF;
    END IF;
...
INSERT INTO TIPO_PLATO VALUES (3, 'Cena');
...
INSERT INTO HABITACION VALUES(101, 'Disponible', 2, 1);
INSERT INTO HABITACION VALUES(102, 'Disponible', 3, 1);
INSERT INTO HABITACION VALUES(103, 'Mantenimiento', 1, 2);
INSERT INTO HABITACION VALUES(104, 'Disponible', 2, 2);
INSERT INTO HABITACION VALUES(105, 'Disponible', 1, 3);
INSERT INTO HABITACION VALUES(106, 'Disponible', 2, 3);
INSERT INTO HABITACION VALUES(107, 'Disponible', 2, 4);
INSERT INTO HABITACION VALUES(108, 'Mantenimiento', 3, 4);
INSERT INTO HABITACION VALUES(109, 'Disponible', 3, 5);

INSERT INTO HABITACION VALUES(201, 'Disponible', 3, 1);
INSERT INTO HABITACION VALUES(202, 'Disponible', 1, 1);
INSERT INTO HABITACION VALUES(203, 'Disponible', 2, 2);
INSERT INTO HABITACION VALUES(204, 'Mantenimiento', 3, 2);
INSERT INTO HABITACION VALUES(205, 'Disponible', 3, 3);
INSERT INTO HABITACION VALUES(206, 'Disponible', 3, 3);
INSERT INTO HABITACION VALUES(207, 'Disponible', 1, 4);
INSERT INTO HABITACION VALUES(208, 'Disponible', 2, 4);
INSERT INTO HABITACION VALUES(209, 'Disponible', 3, 5);

INSERT INTO HABITACION VALUES(301, 'Disponible', 1, 1);
INSERT INTO HABITACION VALUES(302, 'Mantenimiento', 2, 1);
INSERT INTO HABITACION VALUES(303, 'Disponible', 3, 2);
INSERT INTO HABITACION VALUES(304, 'Disponible', 1, 2);
INSERT INTO HABITACION VALUES(305, 'Disponible', 2, 3);
INSERT INTO HABITACION VALUES(306, 'Disponible', 3, 3);
INSERT INTO HABITACION VALUES(307, 'Disponible', 3, 4);
INSERT INTO HABITACION VALUES(308, 'Mantenimiento', 2, 4);
INSERT INTO HABITACION VALUES(309, 'Mantenimiento', 3, 5);

--Cambios: 28/05

ALTER TABLE DETALLE_HABITACION DROP COLUMN FECHA_LLEGADA;
ALTER TABLE DETALLE_HABITACION DROP COLUMN FECHA_SALIDA;
ALTER TABLE DETALLE_PASAJEROS ADD FECHA_LLEGADA DATE NOT NULL;
ALTER TABLE DETALLE_PASAJEROS ADD FECHA_SALIDA DATE NOT NULL;

CREATE SEQUENCE SEQ_DETALLE_HABITACION
MINVALUE 1
START WITH 1
INCREMENT BY 1;

CREATE SEQUENCE SEQ_DETALLE_PASAJEROS
MINVALUE 1
START WITH 1
INCREMENT BY 1;
...
create or replace TRIGGER TGR_DETALLE_HABITACION
BEFORE INSERT ON DETALLE_HABITACION
FOR EACH ROW
 WHEN (new.ID_DETALLE_H IS NULL or new.ID_DETALLE_H = 0) 
BEGIN
  SELECT SEQ_DETALLE_HABITACION.NEXTVAL
  INTO :new.ID_DETALLE_H
  FROM dual;
END;

/

create or replace TRIGGER TGR_DETALLE_PASAJEROS
BEFORE INSERT ON DETALLE_PASAJEROS
FOR EACH ROW
 WHEN (new.ID_DETALLE_PASAJEROS IS NULL or new.ID_DETALLE_PASAJEROS = 0) 
BEGIN
  SELECT SEQ_DETALLE_PASAJEROS.NEXTVAL
...
ALTER TABLE PENSION
MODIFY NOMBRE_PENSION VARCHAR2(35);

ALTER TABLE DETALLE_BOLETA
MODIFY ID_BOLETA NUMBER(10) NOT NULL;

ALTER TABLE DETALLE_PEDIDO
MODIFY NUMERO_PEDIDO NUMBER(5) NOT NULL;

ALTER TABLE DETALLE_RECEPCION
MODIFY NUMERO_RECEPCION NUMBER(5) NOT NULL;

--Cambios: 19/06

DELETE FROM DETALLE_HABITACION;

ALTER TABLE DETALLE_PASAJEROS
DROP CONSTRAINT FK_DETALLE_PENSION_P;

ALTER TABLE DETALLE_PASAJEROS
DROP CONSTRAINT FK_HABITACION_DETALLE_P;

ALTER TABLE DETALLE_PASAJEROS
DROP CONSTRAINT FK_HUESPED_DETALLE_P;

DROP TABLE DETALLE_PASAJEROS;
...
ALTER TABLE DETALLE_HABITACION
ADD CONSTRAINT FK_HUESPED_DETALLE_H FOREIGN KEY(RUT_HUESPED) REFERENCES HUESPED(RUT_HUESPED);

ALTER TABLE DETALLE_HABITACION
ADD CONSTRAINT FK_PENSION_DETALLE_H FOREIGN KEY(ID_PENSION) REFERENCES PENSION(ID_PENSION);

--FUNCIONES ALMACENADA
CREATE OR REPLACE FUNCTION FN_CANTIDAD_ORDENES_TIPO(RUT NUMBER,ESTADO VARCHAR2) 
RETURN NUMBER
IS
  CANTIDAD NUMBER;
BEGIN
    SELECT COUNT(NUMERO_ORDEN) INTO CANTIDAD
    FROM ORDEN_COMPRA
    WHERE RUT_CLIENTE = RUT AND ESTADO_ORDEN = ESTADO
    ...
    ELSE
        RETURN(0);
    END IF;
END FN_CANTIDAD_ORDENES_TIPO;

/

CREATE OR REPLACE FUNCTION FN_CALCULAR_DIAS(NUM_HAB NUMBER) RETURN NUMBER IS
    v_dias NUMBER DEFAULT 0;
    CURSOR cur IS
        SELECT FECHA_LLEGADA,
               FECHA_SALIDA
        FROM DETALLE_HABITACION
        WHERE NUMERO_HABITACION = NUM_HAB;
BEGIN
    FOR v_reg IN cur LOOP
        v_dias := v_dias + (TRUNC(v_reg.FECHA_SALIDA)-TRUNC(v_reg.FECHA_LLEGADA));
    END LOOP;
    RETURN v_dias;
END FN_CALCULAR_DIAS;

--VISTAS
CREATE OR REPLACE VIEW V_CLIENTE_ORDENES
AS 
SELECT cli.RUT_CLIENTE || '-' || cli.DV_CLIENTE AS RUT,
       cli.NOMBRE_CLIENTE AS "NOMBRE_CLIENTE",
       g.NOMBRE_GIRO AS GIRO,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Pendiente'),0) AS ORDENES_PENDIENTES,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Asignado'),0) AS ORDENES_ASIGNADAS,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Aceptado'),0) AS ORDENES_ACEPTADAS,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Cerrado'),0) AS ORDENES_CERRADAS,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Rechazado'),0) AS ORDENES_RECHAZADAS,
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Cancelado'),0) AS ORDENES_CANCELADAS,
       COUNT(oc.NUMERO_ORDEN) AS "CANTIDAD_ORDENES"
FROM ORDEN_COMPRA oc JOIN CLIENTE cli
ON cli.RUT_CLIENTE = oc.RUT_CLIENTE
JOIN GIRO g ON cli.ID_GIRO = g.ID_GIRO
GROUP BY cli.RUT_CLIENTE || '-' || cli.DV_CLIENTE,cli.NOMBRE_CLIENTE,g.NOMBRE_GIRO,
        NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Pendiente'),0),
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Asignado'),0),
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Aceptado'),0),
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Cerrado'),0),
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Rechazado'),0),
       NVL(FN_CANTIDAD_ORDENES_TIPO(cli.RUT_CLIENTE,'Cancelado'),0)
ORDER BY COUNT(oc.NUMERO_ORDEN) DESC;

CREATE OR REPLACE FORCE VIEW V_CLIENTE_ORDENES_TOP_10
AS
SELECT * FROM(
SELECT cli.RUT_CLIENTE || '-' || cli.DV_CLIENTE AS RUT,
       cli.NOMBRE_CLIENTE AS "NOMBRE_CLIENTE",
...
CREATE OR REPLACE FORCE VIEW V_HABITACION_PREFERIDA
AS 
SELECT hab.NUMERO_HABITACION AS NUMERO_HABITACION,
       COUNT(hab.ID_DETALLE_H) AS NUMERO_USOS
FROM DETALLE_HABITACION hab
GROUP BY hab.NUMERO_HABITACION
HAVING COUNT(hab.ID_DETALLE_H) = (SELECT MAX(COUNT(ID_DETALLE_H))
                                  FROM DETALLE_HABITACION
                                  GROUP BY NUMERO_HABITACION)
ORDER BY COUNT(hab.ID_DETALLE_H) DESC;

CREATE OR REPLACE FORCE VIEW V_HABITACION_USOS
AS 
SELECT hab.NUMERO_HABITACION AS NUMERO_HABITACION,
       COUNT(hab.ID_DETALLE_H) AS NUMERO_USOS
FROM DETALLE_HABITACION hab
...
CREATE OR REPLACE FORCE VIEW V_HABITACION_USOS_TOP_10
AS
SELECT * FROM(
SELECT hab.NUMERO_HABITACION AS NUMERO_HABITACION,
       COUNT(hab.ID_DETALLE_H) AS NUMERO_USOS
FROM DETALLE_HABITACION hab
GROUP BY hab.NUMERO_HABITACION
ORDER BY COUNT(hab.ID_DETALLE_H) DESC,hab.NUMERO_HABITACION ASC)
WHERE ROWNUM <=10;

CREATE OR REPLACE VIEW V_DIAS_USOS AS
SELECT NUMERO_HABITACION,
       FN_CALCULAR_DIAS(NUMERO_HABITACION) AS DIAS_USO
FROM HABITACION
...
ADD MONTO_TOTAL NUMBER(6) NOT NULL;

ALTER TABLE DETALLE_ORDEN
ADD VALOR_MINUTA NUMBER(6) NOT NULL;

ALTER TABLE DETALLE_ORDEN
ADD VALOR_HABITACION NUMBER(6) NOT NULL;

--Cambios 24/06
ALTER TABLE ORDEN_COMPRA MODIFY RUT_CLIENTE NOT NULL;

ALTER TABLE DETALLE_ORDEN 
ADD ID_TIPO_HABITACION NUMBER(5) NOT NULL;

ALTER TABLE DETALLE_ORDEN
ADD CONSTRAINT FK_DETALLE_OR_TIPO_HAB FOREIGN KEY(ID_TIPO_HABITACION) REFERENCES TIPO_HABITACION(ID_TIPO_HABITACION);

--Cambios 27/06 
ALTER TABLE FACTURA
ADD NUMERO_ORDEN NUMBER(5);

ALTER TABLE FACTURA
ADD CONSTRAINT FK_FACTURA_ORDEN FOREIGN KEY(NUMERO_ORDEN) REFERENCES ORDEN_COMPRA(NUMERO_ORDEN);

ALTER TABLE DETALLE_FACTURA
ADD VALOR_DESC NUMBER(15);
...
CREATE SEQUENCE seq_detalle_boleta
MINVALUE 1
START WITH 1
INCREMENT BY 1;

create or replace TRIGGER TGR_BOLETA
BEFORE INSERT ON BOLETA
FOR EACH ROW
 WHEN (new.ID_BOLETA IS NULL or new.ID_BOLETA = 0)
BEGIN
  SELECT SEQ_BOLETA.NEXTVAL
  INTO :new.ID_BOLETA
  FROM dual;
END;

create or replace TRIGGER TGR_FACTURA
BEFORE INSERT ON FACTURA
FOR EACH ROW
 WHEN (new.ID_FACTURA IS NULL or new.ID_FACTURA = 0)
BEGIN
...
create or replace TRIGGER TGR_DETALLE_FACTURA
BEFORE INSERT ON DETALLE_FACTURA
FOR EACH ROW
 WHEN (new.ID_DETALLE_FACTURA IS NULL or new.ID_DETALLE_FACTURA = 0)
BEGIN
  SELECT SEQ_FACTURA.CURRVAL
  INTO :new.ID_FACTURA
  FROM dual;

  SELECT SEQ_DETALLE_FACTURA.NEXTVAL
  INTO :new.ID_DETALLE_FACTURA
  FROM dual;
END;

create or replace TRIGGER TGR_DETALLE_BOLETA
BEFORE INSERT ON DETALLE_BOLETA
FOR EACH ROW
 WHEN (new.ID_DETALLE_BOLETA IS NULL or new.ID_DETALLE_BOLETA = 0)
BEGIN
  SELECT SEQ_BOLETA.CURRVAL
  INTO :new.ID_BOLETA
  FROM dual;

  SELECT SEQ_DETALLE_BOLETA.NEXTVAL
  INTO :new.ID_DETALLE_BOLETA
  FROM dual;
END;

--Cambios 01-07
CREATE TABLE DIVISA(
  ID_DIVISA NUMBER(5) CONSTRAINT PK_DIVISA PRIMARY KEY,
  NOMBRE_DIVISA VARCHAR2(3) NOT NULL UNIQUE,
  PRECIO_DIVISA DECIMAL(6,2) NOT NULL
);

--Cambios 02-07

CREATE OR REPLACE TRIGGER TGR_NOTIFICACION_CLIENTE
AFTER UPDATE ON ORDEN_COMPRA
FOR EACH ROW
DECLARE
CURSOR CUR_CLIENTE IS SELECT RUT_CLIENTE, ID_USUARIO FROM CLIENTE WHERE RUT_CLIENTE = :NEW.RUT_CLIENTE;

BEGIN
  IF UPDATING('ESTADO_ORDEN') THEN
    IF :NEW.ESTADO_ORDEN = 'Asignado' THEN
        FOR I IN CUR_CLIENTE LOOP
              INSERT INTO NOTIFICACION(ID_NOTIFICACION, MENSAJE, ID_USUARIO, ESTADO_NOTIFICACION, URL, NUMERO_ORDEN)
              VALUES(SEQ_NOTIFICACION.NEXTVAL, 'La Reserva ' || :new.NUMERO_ORDEN || ' ha sido aceptada y asignada, para ver el detalle ingrese a su historial', I.ID_USUARIO, 'Habilitado', '../Cliente/WebVerHistorial.aspx', :NEW.NUMERO_ORDEN);
        END LOOP;
    END IF;
  END IF;

  IF UPDATING('ESTADO_ORDEN') THEN
    IF :NEW.ESTADO_ORDEN = 'Cerrado' THEN
        FOR I IN CUR_CLIENTE LOOP
            UPDATE NOTIFICACION
            SET ESTADO_NOTIFICACION = 'Deshabilitado'
            WHERE ID_USUARIO = I.ID_USUARIO AND NUMERO_ORDEN = :NEW.NUMERO_ORDEN;
...
ALTER TABLE DETALLE_HABITACION
ADD NUMERO_ORDEN NUMBER(5) NOT NULL;

ALTER TABLE DETALLE_HABITACION
ADD CONSTRAINT FK_DETALLE_HAB_ORDEN FOREIGN KEY(NUMERO_ORDEN) REFERENCES ORDEN_COMPRA(NUMERO_ORDEN);

--Inserción de valores

INSERT INTO DIVISA VALUES(1, 'CLP', 1);
INSERT INTO DIVISA VALUES(2, 'USD', 654);
INSERT INTO DIVISA VALUES(3, 'EUR', 761);