...
delete from detalle_pasajeros;

delete from detalle_platos;

delete from pension

ALTER TABLE PENSION
ADD HABILITADO VARCHAR2(1) NOT NULL;

ALTER TABLE FACTURA
ADD METODO_PAGO VARCHAR2(30) NOT NULL;

ALTER TABLE DETALLE_FACTURA
ADD VALOR_UNITARIO NUMBER(10) NOT NULL;

ALTER TABLE DETALLE_FACTURA
DROP CONSTRAINT FK_DETALLE_FACTURA_CLIENTE;

ALTER TABLE DETALLE_FACTURA
DROP COLUMN RUT_CLIENTE;
=======
--Cambios: 19/06

CREATE OR REPLACE VIEW V_CLIENTE_FRECUIENTE AS 
...
>>>>>>> 651a0afd84545d7c9a61b8e2d4802dfc429c851c
