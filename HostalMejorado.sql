  ...
  IF UPDATING('STOCK_PRODUCTO') THEN
    IF :NEW.STOCK_PRODUCTO <= :NEW.STOCK_CRITICO_PRODUCTO THEN
      FOR I IN CUR_USUARIO LOOP
        ...
        VALUES(SEQ_NOTIFICACION.NEXTVAL, 'El Producto' || :NEW.NOMBRE_PRODUCTO || 'Está por agotarse', I.ID_USUARIO, 'Habilitado', '../Empleado/WebVerProductos.aspx', :NEW.ID_PRODUCTO);
      END LOOP;
    END IF;
  END IF;
