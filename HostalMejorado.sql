...
--Cambios a Notificacion, SE RECOMIENDA BORRAR TODAS LAS ANTERIORES NOTIFICACIONES

ALTER TABLE NOTIFICACION
ADD URL VARCHAR2(50) NOT NULL;
ALTER TABLE NOTIFICACION
ADD NUMERO_PEDIDO NUMBER(5);
ALTER TABLE NOTIFICACION
ADD ID_PRODUCTO NUMBER(19);
ALTER TABLE NOTIFICACION
ADD NUMERO_ORDEN NUMBER(5);
ALTER TABLE NOTIFICACION
ADD CONSTRAINT FK_NOTIFICACION_PEDIDO FOREIGN KEY(NUMERO_PEDIDO) REFERENCES PEDIDO(NUMERO_PEDIDO);
ALTER TABLE NOTIFICACION
ADD CONSTRAINT FK_NOTIFICACION_PRODUCTO FOREIGN KEY(ID_PRODUCTO) REFERENCES PRODUCTO(ID_PRODUCTO);
ALTER TABLE NOTIFICACION
ADD CONSTRAINT FK_NOTIFICACION_ORDEN FOREIGN KEY(NUMERO_ORDEN) REFERENCES ORDEN_COMPRA(NUMERO_ORDEN);
...
--Cambios a la tabla de detalle orden reserva
ALTER TABLE DETALLE_ORDEN
ADD ID_CATEGORIA_HABITACION NUMBER(3) NOT NULL;
ALTER TABLE DETALLE_ORDEN 
ADD ID_PENSION NUMBER(5) NOT NULL;
ALTER TABLE DETALLE_ORDEN 
ADD CONSTRAINT FK_DETALLE_ORDEN_CATEGORIA FOREIGN KEY(ID_CATEGORIA_HABITACION) REFERENCES CATEGORIA_HABITACION(ID_CATEGORIA_HABITACION);
ALTER TABLE DETALLE_ORDEN 
ADD CONSTRAINT FK_DETALLE_ORDEN_PENSION FOREIGN KEY(ID_PENSION) REFERENCES PENSION(ID_PENSION);
...
ADD ESTADO_ORDEN VARCHAR2(25) NOT NULL;
ALTER TABLE ORDEN_COMPRA
ADD COMENTARIO VARCHAR2(256);

--Secuencia y Trigger Minuta
...
ALTER TABLE PENSION
MODIFY NUMERO_HABITACION NUMBER(5) NULL;
...
ALTER TABLE BOLETA RENAME COLUMN RUT_CLIENTE TO RUT_HUESPED;
ALTER TABLE BOLETA MODIFY RUT_HUESPED NOT NULL;
