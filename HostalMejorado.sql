...
--ESTOS TRIGGER YA NO CORREN. SE CAMBIARA A PROCEDIMIENTO ALMACENADO EN UN FUTURO.
...
BEGIN
    ...
    IF :NEW.ESTADO_PEDIDO != 'Pendiente' THEN
        FOR I IN CUR_NOTIFICACION LOOP
          FOR J IN CUR_USUARIO LOOP
            IF I.ID_USUARIO = J.ID_USUARIO THEN
              IF I.ESTADO_NOTIFICACION = 'Habilitado' THEN
                UPDATE NOTIFICACION
                SET ESTADO_NOTIFICACION = 'Deshabilitado'
                WHERE J.ID_USUARIO = I.ID_USUARIO;
              END IF;
...
--Creación Trigger Aumentar Stock Producto
create or replace TRIGGER TGR_STOCK_PRODUCTO
BEFORE INSERT ON DETALLE_RECEPCION
DECLARE
CURSOR CUR_PRODUCTO IS SELECT ID_PRODUCTO, STOCK_PRODUCTO FROM PRODUCTO WHERE ID_PRODUCTO = :NEW.ID_PRODUCTO;

BEGIN
  FOR I IN CUR_PRODUCTO LOOP
    IF I.ID_PRODUCTO = :NEW.ID_PRODUCTO THEN
      UPDATE PRODUCTO
      SET STOCK_PRODUCTO = STOCK_PRODUCTO + :NEW.CANTIDAD
