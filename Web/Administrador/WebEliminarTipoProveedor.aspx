<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/AdminM.Master" AutoEventWireup="true" CodeBehind="WebEliminarTipoProveedor.aspx.cs" Inherits="Web.Administrador.WebEliminarTipoProveedor" %>
      ...
      <div class="main-login main-center">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    <h5>Eliminar Tipo Proveedor</h5>         
                </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Confirme si desea eliminar el Tipo Proveedor </label>
                <div class="col-sm-12">
