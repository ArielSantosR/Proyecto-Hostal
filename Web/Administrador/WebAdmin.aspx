    ...
    <div class="row main">
        <div class="main-login main-center-wide">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-4">
                    <asp:button runat="server" Text="Empleado" CssClass="btn btn-primary active  btn-lg btn-block login-button" data-toggle="collapse" data-target="#empleado" OnClientClick="return false" />
                    <div id="empleado" class="collapse" style="margin-top: 10px;">
                            <asp:button runat="server" Text="Gestión Habitaciones" CssClass="btn btn-danger  btn-lg btn-block login-button" data-toggle="collapse" data-target="#Habitacion" OnClientClick="return false"/>
                            ...
                            <div id="Producto" class="collapse" style="margin-top: 10px;">
                            ...
                            <asp:button runat="server" text="Inventario" ID="btnInventario" cssClass="btn btn-primary btn-lg btn-block login-button" style="font-size: 15px" OnClick="btnInventario_Click"   />
                            </div>
                        </div>
                    </div>
                <div class="col-md-4">
