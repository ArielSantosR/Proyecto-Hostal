<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/AdminM.Master" AutoEventWireup="true" CodeBehind="WebEliminarHabitacion.aspx.cs" Inherits="Web.Administrador.WebEliminarHabitacion" %>
    ...
    <div class="row main">
      <div class="main-login main-center">
            ...
            <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Confirme si desea eliminar la habitación </label>
                <div class="col-sm-12">
