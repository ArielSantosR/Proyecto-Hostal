<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/AdminM.Master" AutoEventWireup="true" CodeBehind="WebEliminarPlato.aspx.cs" Inherits="Web.Administrador.WebEliminarPlato" %>
      ...
      <div class="main-login main-center">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    <h5>Eliminar Plato</h5>         
                </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Confirme si desea eliminar el plato </label>
                <div class="col-sm-12">
