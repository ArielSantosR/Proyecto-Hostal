    ...
    public partial class WebRegistroAdmin : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender,EventArgs e) {
            ...
            if (!IsPostBack) {
                ...
                ddlTipoProveedor.Items.Insert(0,new ListItem("Seleccione Tipo de Proveedor...","0"));
                ...
                ddlTipo.DataSource = Enum.GetValues(typeof(Tipo_Usuario));
                ddlTipo.DataBind();
                ddlTipo.Items.Insert(0,new ListItem("Seleccione Tipo de Usuario...","0"));
                    ...
                    if (ddlEstado.SelectedIndex != 0) {
                        ...
                        if (txtPassword.Text.Equals(txtConfirmar.Text)) {
                            if (!s.ExisteUsuario(writer.ToString())) {
                                if (usuario.TIPO_USUARIO.Equals(Tipo_Usuario.Cliente.ToString())) {
                                    if (ddlGiro.SelectedIndex != 0) {
                                        ...
                                        error.Text = "Debe escoger un giro válido";
                                        alerta.Visible = true;
                                        alerta_exito.Visible = false;
                                    }
                                }
                                else if (usuario.TIPO_USUARIO.Equals(Tipo_Usuario.Empleado.ToString()) || usuario.TIPO_USUARIO.Equals(Tipo_Usuario.Administrador.ToString())) {
                                ...
                                else if (usuario.TIPO_USUARIO.Equals(Tipo_Usuario.Proveedor.ToString())) {
                                    if (ddlTipoProveedor.SelectedIndex != 0) {
                                        ...
                                        alerta_exito.Visible = false;
                                        error.Text = "Debe seleccionar un tipo de proveedor valido";
                                        alerta.Visible = true;
                                    }
                                }
                        ...
                        alerta_exito.Visible = false;
                        error.Text = "Debe seleccionar un estado valido";
                        alerta.Visible = true;
                    }
                }else {
                    alerta_exito.Visible = false;
