...
{
    public partial class WebCrearCategoriaPlato : System.Web.UI.Page
    {
        ...
        protected void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (txtNombre.Text != string.Empty)
            {
                ...
                if (s.AgregarCategoria(writer.ToString()))
                {
                    exito.Text = "La Categoría de Plato ha sido agregado con éxito";
