                    ...
                    <div class="row main">
                      <div class="main-login main-center">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row"> 
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                                    <asp:Button ID="LoginButton" runat="server" CssClass="btn btn-warning btn-lg btn-block login-button" CommandName="Login" Text="Inicio de sesión" ValidationGroup="Login1" />
                              </div>
						</div>
                        <div class="row"> 
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
