<%@ Page Title="" Language="C#" MasterPageFile="~/Empleado/EmpleadoM.Master" AutoEventWireup="true" CodeBehind="WebEditarInventario.aspx.cs" Inherits="Web.Empleado.WebEditarInventario" %>
            ...
            <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Nombre del Producto</label>
                <div class="col-sm-12">
                  ...
                  <asp:TextBox ID="txtNombre" placeholder="Ingrese nombre del producto" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                </div>
              </div>
            </div>
         <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Precio</label>
                <div class="col-sm-12">
                  ...
                  <asp:TextBox ID="txtPrecio" placeholder="Ingrese Precio del Producto"  runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                </div>
              </div>
            </div> 
          <div class="form-group">
          ...
          <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Stock Critico</label>
                <div class="col-sm-12">
                  <div class="input-group">
                  <span class="input-group-text"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                  <asp:TextBox ID="txtStockCritico" placeholder="Ingrese Stock Critico"  runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                </div>
              </div>
            </div>
          <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Descripción</label>
                <div class="col-sm-12">
                  <div class="input-group">
                  <span class="input-group-text"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                  <asp:TextBox ID="txtDescripcion" placeholder="Ingrese Descripción"  runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                </div>
              </div>
            </div> 
        ...
        <div class="form-group">
              <label for="name" class="col-sm-12 control-label">Familia </label>
                <div class="col-sm-12">
                  <div class="input-group">
                  <span class="input-group-text"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                      <asp:DropDownList ID="ddlFamilia" CssClass="form-control" runat="server" ReadOnly="true" Enabled="False">
                      </asp:DropDownList>    
                </div>
              </div>
            </div> 
              ...
              <label for="name" class="col-sm-12 control-label">Unidad de Medida </label>
                <div class="col-sm-12">
                  <div class="input-group">
                  <span class="input-group-text"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                      <asp:DropDownList ID="ddlUnidad" CssClass="form-control" runat="server" Enabled="False" ReadOnly="true">
                      </asp:DropDownList>    
                </div>
              </div>
            </div> 
