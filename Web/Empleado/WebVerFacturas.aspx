<%@ Page Title="" Language="C#" MasterPageFile="~/Empleado/EmpleadoM.Master" AutoEventWireup="true" CodeBehind="WebVerFacturas.aspx.cs" Inherits="Web.Empleado.WebVerFacturas" %>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="form-group">
                            <div style="display: flex; justify-content: center; margin-bottom: 70px">
                                <asp:GridView ID="gvFacturas" runat="server" ForeColor="#333333" GridLines="Vertical" CssClass="text-center rounded" AllowPaging="True" PageSize="8" DataKeyNames="Número Factura" OnSelectedIndexChanged="gvFacturas_SelectedIndexChanged" OnPageIndexChanging="gvFacturas_PageIndexChanging">
                        ...
                        <div class="container">
                            <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
                                <div class="main-center">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                                            <h1>No hay ninguna factura emitida</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
